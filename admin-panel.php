...
if(isset($_GET["generate_bill"])) {
    ...
    $content .= '
        <br/>
        <h2 align ="center"> CHRONOHEALTH</h2></br>
...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> CHRONOHEALTH </a>
                ...
                <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                    <div class="tab-pane fade show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
                        ...
                        <div style="display: flex; justify-content: center; gap: 40px; flex-wrap: wrap; margin-top: 30px;">
                            <!-- New Button: Patient Dashboard -->
                            <div style="text-align: center;">
                                <div style="font-size: 40px; color: #4b4bc4;">👤</div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form-group" method="post" action="admin-panel.php">
                                        <div class="row">
                                            ...
                                            <script>
                                                document.getElementById('spec').onchange =                                                     docs.forEach((el, ind, arr) => {
